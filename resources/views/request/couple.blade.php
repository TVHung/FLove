                ...
                <div class="col-md-7">
                    ...
                    <table class="text-left"  style="margin-left: 10%;">
                        ...
                        <tr>
                          ...
                          <td style="font-size: 18px; width:250px; height: 30px">{{$infor_couple->name}}</td>
                        </tr>
                        @endif
...
<div class="container">
    <div class="row" style="margin-top:20px;">
        ...
        <a name="" id="Midnights" class="btn btn-success " href="{{route('information')}}" role="button">Back</a>
        </div>
        
        <div class="col-md-6 text-center" style="margin-bottom:30px;">
        <a name="" id="Midnights2" class="btn btn-success " href="{{route('break')}}" role="button">Break</a>
        </div>
    </div>
</div>
