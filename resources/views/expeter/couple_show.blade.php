...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
 ...
 <section id="service" class="home-section text-center bg-gray">
    ...
    <div class="container">
            ...
            <div class="wow fadeInLeft" data-wow-delay="0.2s">
              <div class="service-box couple_show_box">
                <div class="service-icon">
                  <img  src="avatar/{{$if->id}}.jpg" alt="">
                </div>
                <div class="service-desc">
                  <a  href="heart_choice_detail/{{$if->id}}" target="_blank">{{$if->name}}</a>
                </div>
                <br>
      ...
      <div class="row">
        <a name="" id="Midnights" class="btn btn-success" href="{{route('expeter_list.index')}}" role="button"  style="margin-top: 40px;">Back</a>
      </div>
    </div>
  </section>
