  ...
  <div class="container" style = "margin-top:-50px;">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <form method="post" action="<?php echo e(route('postEditInfor')); ?>" enctype="multipart/form-data">
...
<?php /**PATH D:\xampp\htdocs\f_love\resources\views/login/edit_infor.blade.php ENDPATH**/ ?>