<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color: #40B2D2;">
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
        ...
        <li ><a href="<?php echo e(route('expeter_list.index')); ?>">Expeter</a></li>
        <li class="active"><a href="<?php echo e(route('hc_list.index')); ?>">Heart's choice</a></li>
...
<?php /**PATH D:\xampp\htdocs\f_love\resources\views/heart_choices/hc_header.blade.php ENDPATH**/ ?>