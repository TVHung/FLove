  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
      ...
      <li><a href="<?php echo e(route('expeter_list.index')); ?>">Expecter</a></li>
        <li><a href="<?php echo e(route('hc_list.index')); ?>">Heart's Choices</a></li>
      <li class="active"><a href="<?php echo e(route('information')); ?>"><?php echo e($user->name); ?></a></li>
      ...
      <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="border">
            ...
            <a href="seeInfor/<?php echo e($var->id2); ?>" class="dropdown-item">
               <?php echo e($var->id2); ?> send you a request
                ...
                <div class="col-md-7">
                    ...
                    <table class="text-left"  style="margin-left: 10%;">
                        ...
                        <tr>
                          ...
                          <td style="font-size: 18px; width:250px; height: 30px"><a href="couple"><?php echo e($infor_couple->name); ?></a></td>
                        </tr>
                        <?php endif; ?>
...
<div class="container">
    <div class="row" style="margin-top:30px;">
        ...
        <a name="" id="Midnights" class="btn btn-success " href="<?php echo e(route('update.index')); ?>" role="button">Update</a>
        </div>
        
        <div class="col-md-6 text-center" style="margin-bottom:30px;">
        <a name="" id="Midnights" class="btn btn-success " href="<?php echo e(route('changePassword')); ?>" role="button">Change your password</a>
        </div>
    </div>
</div>
...
</html><?php /**PATH D:\xampp\htdocs\f_love\resources\views/home/infor.blade.php ENDPATH**/ ?>