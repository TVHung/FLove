        ...
        <div class="row">
            ...
            <div class="col-md-5" >
              <div class="img_to_show">
                <img src="avatar/<?php echo e($infor->id); ?>.jpg" alt="" >
                <div class="gra"></div>
              </div>
              <?php if($message->message): ?>
                <div class="row" style="margin-top:50px">
                  <div class="col-md-12 text-center">
                      <?php echo e($infor->name); ?> has sent you a request with a message: <h3 style="color: blue">"<?php echo e($message->message); ?>"</h3>
                  </div>
                </div>
              <?php endif; ?>
            </div>
...
<div class="container">
    ...
    <div class="row" style="margin-top:20px;">
        ...
        <a name="" id="Midnights" class="btn btn-success " href="accept/<?php echo e($infor->id); ?>" role="button">Accept</a>
        </div>
        
        <div class="col-md-6 text-center" style="margin-bottom:30px;">
        <a name="" id="Midnights2" class="btn btn-success " href="denine/<?php echo e($infor->id); ?>" role="button">Denine</a>
        </div>
    </div>
</div>
...
</html><?php /**PATH D:\xampp\htdocs\f_love\resources\views/request/seeInfor.blade.php ENDPATH**/ ?>