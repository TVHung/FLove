<?php $__env->startSection('content_all'); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-3 order-lg-1 order-2 text-center" id="cate_gories">
                <div class="li-blog-sidebar-wrapper" style="margin-top:43px;">
                    <form action="<?php echo e(route('hc_list.index')); ?>" method="get">
            ...
            <div class="col-md-9">
                <div class="row">
                    <div><h5 style="color: seagreen;padding-left:50px;">Found <?php echo e($info->total()); ?> people</h5></div>
                </div>
                <div class="row hc_one_row">
                    ...
                    <?php if($inf->sex == "Male"): ?>
                        <div class="col-md-4 text-center hc_one_col hc_male" >
                            <img class="avatar" src="avatar/<?php echo e($inf->id); ?>.jpg" alt="">
                            <h3 class="user_name"><?php echo e($inf->name); ?></h3>
                            <div class="hc_white"></div>
                            <h4 class="hc_address"><?php echo e($inf->address); ?></h4>
                            <h4 class="hc_age "><?php echo e($inf->date); ?></h4>
                            <h4 class="hc_state"><?php echo e($inf->state); ?></h4>
                            <div class="readmore" style="margin:-5px 0 5px 0;">
                                <a href="heart_choice_detail/<?php echo e($inf->id); ?>">Views more ... <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    <?php endif; ?>
                    <?php if($inf->sex == "Fe_Male"): ?>
                ...
                <div class="row" style="text-align: center"><?php echo e($info->links()); ?></div>
            </div>
            <!-- Result Area -->
...
<?php echo $__env->make('heart_choices.hc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\f_love\resources\views/heart_choices/hc_index.blade.php ENDPATH**/ ?>